...
class RemindersTableCommand extends Command {
	 ...
	 * @var string
	 */
	protected $description = 'Create a migration for the auth reminders table';
	...
	{
		$name = 'create_auth_reminders_table';
	...
	{
		$stub = $this->files->get(__DIR__.'/../../../migrations/2014_05_19_072715_auth_create_auth_reminders_table.php');

		$stub = str_replace('AuthCreateAuthRemindersTable', 'CreateAuthRemindersTable', $stub);

		$stub = str_replace('auth_reminders', $this->getTable(), $stub);
